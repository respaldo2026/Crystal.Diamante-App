-- ========================================
-- LIMPIAR Y RECREAR ADMIN
-- ========================================

-- PASO 1: Eliminar perfil existente
DELETE FROM perfiles 
WHERE identificacion = '94540306';

-- PASO 2: Eliminar usuario existente en auth
DELETE FROM auth.users 
WHERE email = 'crystal.diamante.col@gmail.com';

-- PASO 3: Crear usuario nuevamente
DO $$
DECLARE
    nuevo_id UUID;
BEGIN
